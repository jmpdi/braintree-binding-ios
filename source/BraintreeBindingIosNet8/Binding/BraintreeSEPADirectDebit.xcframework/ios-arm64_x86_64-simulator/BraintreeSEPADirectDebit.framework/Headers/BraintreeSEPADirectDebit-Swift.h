...
SWIFT_RESILIENT_CLASS("_TtC24BraintreeSEPADirectDebit23BTSEPADirectDebitClient")
@interface BTSEPADirectDebitClient : BTWebAuthenticationSessionClient
...
/// \param request a <code>BTSEPADebitRequest</code>
///
/// \param completion This completion will be invoked exactly once when tokenization is complete or an error occurs
///
- (void)tokenizeWithSEPADirectDebitRequest:(BTSEPADirectDebitRequest * _Nonnull)request completion:(void (^ _Nonnull)(BTSEPADirectDebitNonce * _Nullable, NSError * _Nullable))completion;
...
SWIFT_RESILIENT_CLASS("_TtC24BraintreeSEPADirectDebit22BTSEPADirectDebitNonce")
@interface BTSEPADirectDebitNonce : BTPaymentMethodNonce
