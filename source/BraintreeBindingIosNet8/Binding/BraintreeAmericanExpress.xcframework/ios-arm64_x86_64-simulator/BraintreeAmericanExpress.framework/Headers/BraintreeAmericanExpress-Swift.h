...
#ifndef BRAINTREEAMERICANEXPRESS_SWIFT_H
#define BRAINTREEAMERICANEXPRESS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BraintreeAmericanExpress",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <code>BTAmericanExpressClient</code> enables you to look up the rewards balance of American Express cards.
SWIFT_CLASS("_TtC24BraintreeAmericanExpress23BTAmericanExpressClient")
...
/// note:
/// If the nonce is associated with an ineligible card or a card with insufficient points, the rewardsBalance will contain this information as <code>errorMessage</code> and <code>errorCode</code>.
/// <ul>
///   <li>
///     Parameters:
///   </li>
...
///     <code>rewardsBalance</code> will contain information about the rewards balance and <code>error</code> will be <code>nil</code> (see exceptions in note);
///     if it fails, <code>rewardsBalance</code> will be <code>nil</code> and <code>error</code> will describe the failure.
///   </li>
/// </ul>
...
SWIFT_CLASS("_TtC24BraintreeAmericanExpress31BTAmericanExpressRewardsBalance")
...
@property (nonatomic, copy) NSString * _Nullable conversionRate;
/// Optional. The currency amount associated with the rewards balance
@property (nonatomic, copy) NSString * _Nullable currencyAmount;
/// Optional. The currency ISO code associated with the rewards balance
@property (nonatomic, copy) NSString * _Nullable currencyIsoCode;
...
@property (nonatomic, copy) NSString * _Nullable rewardsAmount;
/// Optional. The rewards unit associated with the rewards balance
@property (nonatomic, copy) NSString * _Nullable rewardsUnit;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
